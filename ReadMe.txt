CLustCountAndFit: Python 3.8

Description of project: Fits model parameters for cluster expansion and or Ising model
			This is a modified version of the code used by NamHoon to fit paramiters for his cluster expansion work.
			If you find bugs, have problems, or have questions ask Brian... (Chances are good the bugs are his doing)
Descriptoin of Files:
	...
	clusters_A_all       - data file containing cluster rules for DFT simulations.
...
# If you have duplicate CONTCAR files in your data (or degenerate cluster counts) talk to Brian and He will tell you what to do #
